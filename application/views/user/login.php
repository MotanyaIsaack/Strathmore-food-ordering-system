              ...
              <form action="#">
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input style="font-size:15px;font-family: 'Raleway', sans-serif;" type="text" class="form-control" placeholder="Username">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input style="font-size:15px;font-family: 'Raleway', sans-serif;" type="password" class="form-control input" placeholder="Password">
                  </div>
                </div>
                <div class="form-group">
