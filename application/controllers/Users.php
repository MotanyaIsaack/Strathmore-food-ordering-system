	...
	class Users extends CI_Controller
	{
		...
		public function form_validation()
		{
			...
			else
			{
				...
				// $this->email->from('djokogo@gmail.com', 'Food Ordering System');
				// $this->email->to('$e');
				// $this->email->subject('Account Verification');
				// $this->email->message('Welcome! Your account has been created. Please validate it by clicking the link below.');
				// $this->email->send();
